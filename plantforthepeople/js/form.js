...
/*global console: false, window: false, document: false, Modernizr:false, 
DEBUG:true, $:false, intlTelInput:true */
...
var reset = function () {
  ...
  $errorMsg.html("").hide();
  $validMsg.hide();
  // Code lines from the example provided are shown and commented out below.
  // These lines use error and hide CSS classes,
  // but we are using jQuery's show & hide methods
...
telInput.addEventListener(
  ...
  function () {
    reset();
    //console.log("blur", telInput.value, iti);
    if (telInput.value.trim()) {
      if (iti.isValidNumber()) {
        // Code suggested by the example provided is shown and commented out below.
        //$validMsg.classList.remove("hide");
        // New code using jQuery to show the valid message
        $validMsg.show();
      } else {
        ...
        // New code using jQuery to show the error message
