...
window.onload = function () {
  ...
  */
  ...
  var stopButtonEventHandler = function (event) {
	...
	*/
    mediaElement.pause();
    mediaElement.currentTime = 0; // this seems to be the way to stop -- pause and reset time to 0
    /*
  ...
  */
  ...
  var mediaEventHandler = function (event) {
	...
	*/
    ...
    // TODO: You must set the mediaElement var on this line
    var mediaElement = this; // or use event.currentTarget
    ...
    console.log(
      "mediaEventHandler called with variable created above:",
      mediaElement
    );
	...
	element and set the button variable to that element.
  ...
  */
  ...
  for (let el of mediaElements) {
    //console.log(el);
    el.addEventListener("playing", mediaEventHandler, false);
    el.addEventListener("pause", mediaEventHandler, false);
    el.addEventListener("ended", mediaEventHandler, false);
  }
